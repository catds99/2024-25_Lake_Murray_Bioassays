# 2025-03-17 
# non parametric statistics for conatminant bioassays
...
all_data = read_excel("2024_bioassay_pigment_data.xlsx", sheet = 5)
...
# One-way analysis of means (not assuming equal variances)
# data:  ALL_Chl_a and Treatment
# F = 68.111, num df = 8.000, denom df = 14.472, p-value = 3.97e-10
...
#  8 ALL_Chl_a A               T0         -6.45e+0  -8.03     -4.86   4.46e-6 ****  # 10 ALL_Chl_a B               Control     3.47e+0   0.0964    6.85   4.3 e-2 *     # 15 ALL_Chl_a B               T0         -6.76e+0  -9.69     -3.83   9.55e-4 ***
...
# One-way analysis of means (not assuming equal variances)
# data:  ALL_Chl_a and Treatment
# F = 10.518, num df = 8.000, denom df = 14.729, p-value = 7.225e-05
