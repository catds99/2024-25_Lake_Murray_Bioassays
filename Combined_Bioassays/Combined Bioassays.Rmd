...
knitr::opts_chunk$set(echo = TRUE, fig.width = 4, fig.height = 2.5)
```
...
Q_RFU = read_excel("2025_combinations_master.xlsx", sheet = "Q_RFU")

combined_RFU = read_excel("2025-09-23_data_for_combined_figures.xlsx", sheet = "RFU_72h")
```
...
ggsave(Carb_box, filename = "Figures/end_RFU/Carb_box.png",
...
Dic_box = ggplot() +
  ...
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(Dic_box, filename = "Figures/end_RFU/Dic_box.png",
       device = "png", height = 7, width = 11)
...
PFOS_box = ggplot() +
  ...
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(PFOS_box, filename = "Figures/end_RFU/PFOS_box.png",
       device = "png", height = 7, width = 11)
...
Q_box = ggplot() +
  ...
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(Q_box, filename = "Figures/end_RFU/Q_box.png",
       device = "png", height = 7, width = 11)



combined = ggarrange(Carb_box, Dic_box, PFOS_box, Q_box, 
          ncol = 2, nrow = 2, 
          labels = c("Carb", "Dic", "PFOS", "6ppd-q"),
          common.legend = TRUE, 
          legend = "bottom")
...
###### Percent Difference from Control (Solvent)
...
pd = read_excel("2025_combinations_master.xlsx", sheet = "all_pd")
glimpse(pd)
...
pd_carb = ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_carb, filename = "Figures/percent_difference_control/pd_carb.png",
       device = "png", height = 7, width = 11)
...
pd_dic = ggplot() +
  ...
  scale_y_continuous(limits = c(-65, 145)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_dic, filename = "Figures/percent_difference_control/pd_dic.png",
       device = "png", height = 7, width = 11)
...
pd_PFOS = ggplot() +
  ...
  scale_y_continuous(limits = c(-65, 145)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_PFOS, filename = "Figures/percent_difference_control/pd_PFOS.png",
       device = "png", height = 7, width = 11)
...
pd_Q = ggplot() +
  ...
  scale_y_continuous(limits = c(-65, 145)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_Q, filename = "Figures/percent_difference_control/pd_Q.png",
       device = "png", height = 7, width = 11)
...
delta = read_excel("2025_combinations_master.xlsx", sheet = "all_delta")
...
delta_carb = ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(delta_carb, filename = "Figures/delta_RFU/delta_carb.png",
       device = "png", height = 7, width = 11)
...
delta_dic = ggplot() +
  ...
  scale_y_continuous(limits = c(-3.5, 8.5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(delta_dic, filename = "Figures/delta_RFU/delta_dic.png",
       device = "png", height = 7, width = 11)
...
delta_PFOS = ggplot() +
  ...
  scale_y_continuous(limits = c(-3.5, 8.5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(delta_PFOS, filename = "Figures/delta_RFU/delta_PFOS.png",
       device = "png", height = 7, width = 11)
...
delta_Q = ggplot() +
  ...
  scale_y_continuous(limits = c(-3.5, 8.5)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(delta_Q, filename = "Figures/delta_RFU/delta_Q.png",
       device = "png", height = 7, width = 11)
...
##### Percent Difference in the Change in RFU over 72h
...
pd_delta = read_excel("2025_combinations_master.xlsx", sheet = "all_pd_delta")
glimpse(pd)
...
pd_delta_carb = ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_delta_carb, filename = "Figures/percent_difference_control_delta/pd_delta_carb.png",
       device = "png", height = 7, width = 11)
...
pd_delta_dic = ggplot() +
  ...
  scale_y_continuous(limits = c(-400, 300)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_delta_dic, filename = "Figures/percent_difference_control_delta/pd_delta_dic.png",
       device = "png", height = 7, width = 11)
...
pd_delta_PFOS = ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_delta_PFOS, filename = "Figures/percent_difference_control_delta/pd_delta_PFOS.png",
       device = "png", height = 7, width = 11)
...
pd_delta_Q = ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(pd_delta_Q, filename = "Figures/percent_difference_control_delta/pd_delta_Q.png",
       device = "png", height = 7, width = 11)
...
Dic_change_over_time = ggplot(Dic_change_2, aes(x = Time, y = mean, group = Group, color = Group)) +
  ...
  theme_classic(base_size = 20)
ggsave(Dic_change_over_time, filename = "Figures/Change_over_time/Dic_change_over_time.png",
       device = "png", height = 7, width = 11)
...
Carb_change_over_time = ggplot(Carb_change_2, aes(x = Time, y = mean, group = Group, color = Group)) +
  ...
  theme(legend.position = "bottom") +
  theme_classic(base_size = 20)
ggsave(Carb_change_over_time, filename = "Figures/Change_over_time/Carb_change_over_time.png",
       device = "png", height = 7, width = 11)
...
PFOS_change_over_time = ggplot(PFOS_change_2, aes(x = Time, y = mean, group = Group, color = Group)) +
  ...
  theme(legend.position = "bottom") +
  theme_classic(base_size = 20)
ggsave(PFOS_change_over_time, filename = "Figures/Change_over_time/PFOS_change_over_time.png",
       device = "png", height = 7, width = 11)
...
Q_change_over_time = ggplot(Q_change_2, aes(x = Time, y = mean, group = Group, color = Group)) +
  ...
  theme(legend.position = "bottom") +
  theme_classic(base_size = 20)
ggsave(Q_change_over_time, filename = "Figures/Change_over_time/Q_change_over_time.png",
       device = "png", height = 7, width = 11)
...
Carb_change_over_time
Dic_change_over_time
PFOS_change_over_time
Q_change_over_time
...
all_pam = read_excel("2025_combinations_master.xlsx", sheet = "all_FvFm")
...
carb_pam = ggplot() +
  ...
  theme_classic(base_size = 15) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(carb_pam, filename = "Figures/FvFm/carb_pam.png",
       device = "png", height = 7, width = 11)
...
dic_pam = ggplot() +
  ...
  theme_classic(base_size = 15) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(dic_pam, filename = "Figures/FvFm/dic_pam.png",
       device = "png", height = 7, width = 11)
...
PFOS_pam = ggplot() +
  ...
  theme_classic(base_size = 15) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(PFOS_pam, filename = "Figures/FvFm/PFOS_pam.png",
       device = "png", height = 7, width = 11)
...
Q_pam = ggplot() +
  ...
  theme_classic(base_size = 15) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(Q_pam, filename = "Figures/FvFm/Q_pam.png",
       device = "png", height = 7, width = 11)
